...
namespace eprosima {
    namespace fastdds {
        namespace statistics {
            ...
            SentDataPubSubType::SentDataPubSubType()
            {
                set_name("eprosima::fastdds::statistics::SentData");
                uint32_t type_size = eprosima_fastdds_statistics_SentData_max_cdr_typesize;
                type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
                max_serialized_type_size = type_size + 4; /*encapsulation*/
                is_compute_key_provided = true;
                uint32_t key_length = eprosima_fastdds_statistics_SentData_max_key_cdr_typesize > 16 ? eprosima_fastdds_statistics_SentData_max_key_cdr_typesize : 16;
                key_buffer_ = reinterpret_cast<unsigned char*>(malloc(key_length));
                memset(key_buffer_, 0, key_length);
            }
            ...
            bool SentDataPubSubType::serialize(
                    const void* const data,
                    SerializedPayload_t& payload,
                    DataRepresentationId_t data_representation)
            {
                const SentData* p_type = static_cast<const SentData*>(data);
            ...
            bool SentDataPubSubType::deserialize(
                    SerializedPayload_t& payload,
                    void* data)
            {
                try
                {
                    // Convert DATA to pointer of your type
                    SentData* p_type = static_cast<SentData*>(data);
            ...
            uint32_t SentDataPubSubType::calculate_serialized_size(
                    const void* const data,
                    DataRepresentationId_t data_representation)
            {
                try
                {
                    ...
                    size_t current_alignment {0};
                    return static_cast<uint32_t>(calculator.calculate_serialized_size(
                                *static_cast<const SentData*>(data), current_alignment)) +
                            4u /*encapsulation*/;
                }
                catch (eprosima::fastcdr::exception::Exception& /*exception*/)
                {
            ...
            void* SentDataPubSubType::create_data()
            {
                return reinterpret_cast<void*>(new SentData());
            }

            void SentDataPubSubType::delete_data(
                    void* data)
            {
                delete(reinterpret_cast<SentData*>(data));
            }

            bool SentDataPubSubType::compute_key(
                    SerializedPayload_t& payload,
                    InstanceHandle_t& handle,
                    bool force_md5)
            {
                    ...
                    bool force_md5)
            {
                ...
                // Object that manages the raw buffer.
                eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(key_buffer_),
                        eprosima_fastdds_statistics_SentData_max_key_cdr_typesize);

                // Object that serializes the data.
                eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::BIG_ENDIANNESS, eprosima::fastcdr::CdrVersion::XCDRv2);
                ser.set_encoding_flag(eprosima::fastcdr::EncodingAlgorithmFlag::PLAIN_CDR2);
                eprosima::fastcdr::serialize_key(ser, *p_type);
                if (force_md5 || eprosima_fastdds_statistics_SentData_max_key_cdr_typesize > 16)
                {
                    md5_.init();
                    md5_.update(key_buffer_, static_cast<unsigned int>(ser.get_serialized_data_length()));
                    md5_.finalize();
            ...
            void SentDataPubSubType::register_type_object_representation()
            {
                register_SentData_type_identifier(type_identifiers_);
            }

            ReceivedDataPubSubType::ReceivedDataPubSubType()
            {
                set_name("eprosima::fastdds::statistics::ReceivedData");
                uint32_t type_size = eprosima_fastdds_statistics_ReceivedData_max_cdr_typesize;
                type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
                max_serialized_type_size = type_size + 4; /*encapsulation*/
                is_compute_key_provided = true;
                uint32_t key_length = eprosima_fastdds_statistics_ReceivedData_max_key_cdr_typesize > 16 ? eprosima_fastdds_statistics_ReceivedData_max_key_cdr_typesize : 16;
                key_buffer_ = reinterpret_cast<unsigned char*>(malloc(key_length));
                memset(key_buffer_, 0, key_length);
            }
            ...
            bool ReceivedDataPubSubType::serialize(
                    const void* const data,
                    SerializedPayload_t& payload,
                    DataRepresentationId_t data_representation)
            {
                const ReceivedData* p_type = static_cast<const ReceivedData*>(data);
            ...
            bool ReceivedDataPubSubType::deserialize(
                    SerializedPayload_t& payload,
                    void* data)
            {
                try
                {
                    // Convert DATA to pointer of your type
                    ReceivedData* p_type = static_cast<ReceivedData*>(data);
            ...
            uint32_t ReceivedDataPubSubType::calculate_serialized_size(
                    const void* const data,
                    DataRepresentationId_t data_representation)
            {
                try
                {
                    ...
                    size_t current_alignment {0};
                    return static_cast<uint32_t>(calculator.calculate_serialized_size(
                                *static_cast<const ReceivedData*>(data), current_alignment)) +
                            4u /*encapsulation*/;
                }
                catch (eprosima::fastcdr::exception::Exception& /*exception*/)
                {
            ...
            void* ReceivedDataPubSubType::create_data()
            {
                return reinterpret_cast<void*>(new ReceivedData());
            }

            void ReceivedDataPubSubType::delete_data(
                    void* data)
            {
                delete(reinterpret_cast<ReceivedData*>(data));
            }

            bool ReceivedDataPubSubType::compute_key(
                    SerializedPayload_t& payload,
                    InstanceHandle_t& handle,
                    bool force_md5)
            {
                    ...
                    bool force_md5)
            {
                ...
                // Object that manages the raw buffer.
                eprosima::fastcdr::FastBuffer fastbuffer(reinterpret_cast<char*>(key_buffer_),
                        eprosima_fastdds_statistics_ReceivedData_max_key_cdr_typesize);

                // Object that serializes the data.
                eprosima::fastcdr::Cdr ser(fastbuffer, eprosima::fastcdr::Cdr::BIG_ENDIANNESS, eprosima::fastcdr::CdrVersion::XCDRv2);
                ser.set_encoding_flag(eprosima::fastcdr::EncodingAlgorithmFlag::PLAIN_CDR2);
                eprosima::fastcdr::serialize_key(ser, *p_type);
                if (force_md5 || eprosima_fastdds_statistics_ReceivedData_max_key_cdr_typesize > 16)
                {
                    md5_.init();
                    md5_.update(key_buffer_, static_cast<unsigned int>(ser.get_serialized_data_length()));
                    md5_.finalize();
            ...
            void ReceivedDataPubSubType::register_type_object_representation()
            {
                register_ReceivedData_type_identifier(type_identifiers_);
            }
