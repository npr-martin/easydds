...
{
    set_name("Employee");
    uint32_t type_size = 0; //Employee_max_cdr_typesize;  
    type_size += static_cast<uint32_t>((4 - (type_size % 4)) & (3));//(eprosima::fastcdr::Cdr::alignment(type_size, 4)); /* possible submessage alignment */
    max_serialized_type_size = type_size + 4;                                            /*encapsulation*/
    is_compute_key_provided = false;
    uint32_t key_length = 16; //Employee_max_key_cdr_typesize > 16 ? Employee_max_key_cdr_typesize : 16;
    ...
    DataRepresentationId_t data_representation)
{
    ...
    // std::string printInfo = "length = " + std::to_string(payload.length) + ", spendtime = " + std::to_string(mseconds) + "(ms)\n";
    // std::cout << printInfo;
    return true;
}
    ...
    bool force_md5)
{
    ...
    // if (force_md5 || Employee_max_key_cdr_typesize > 16)
    // {
    //     md5_.init();
