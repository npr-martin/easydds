#ifndef EASYDDS_PUBSUB_TYPES_HPP
#define EASYDDS_PUBSUB_TYPES_HPP
...
#error \
    Generated easydds is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
#endif  // FASTDDS_GEN_API_VER


/*!
 * @brief This class represents the TopicDataType of the type Employee defined by the user in the IDL file.
 * @ingroup easydds
 */
class EmployeePubSubType : public eprosima::fastdds::dds::TopicDataType
{
public:
...
#endif // EASYDDS_PUBSUB_TYPES_HPP
